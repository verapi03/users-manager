...
class HybridauthComponent extends Component {
	...
	/**
     * Wrapper function for handling HybridAuth’s endpoint function
     * 
     * @return string
     */
    ...
    /**
     * get serialized array of actual Hybridauth from provider
     * 
     * @return string
     */
     ...
     * @return boolean wether user have been logged in or not
     */
	protected function normalizeSocialProfile($provider){
		...
		$socialProfile['SocialProfile']['user_name'] = $incomingProfile['displayName'];
